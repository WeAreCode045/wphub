...
Deno.serve(async (req) => {
    try {
        ...
        console.log('[uninstallPlugin] Plugin:', plugin.name, '(slug:', plugin.slug, ')');
        ...
        if (!response.ok) {
            ...
            console.error('[uninstallPlugin] Connector error:', errorText);
        ...
        if (result.success) {
            ...
            console.log('[uninstallPlugin] ✅ Success - plugin uninstalled');
        }

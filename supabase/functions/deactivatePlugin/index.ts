...
import { DeactivatePluginRequestSchema, z } from '../_shared/schemas.ts';
    ...
    try {
      ...
      const { data: { user } } = await supabase.auth.getUser()
        ...
        try {
            ...
            body = DeactivatePluginRequestSchema.parse(parsed);
        } catch (parseError) {
            console.error('[deactivatePlugin] Validation error:', parseError);

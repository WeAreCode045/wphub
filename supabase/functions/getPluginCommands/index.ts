...
import { GetPluginCommandsRequestSchema, z } from '../_shared/schemas.ts';
  ...
  const supabase = createClient(
    ...
    try {
        ...
        try {
            ...
            body = GetPluginCommandsRequestSchema.parse(parsed);
        } catch (parseError) {
            console.error('[getPluginCommands] Validation error:', parseError);
